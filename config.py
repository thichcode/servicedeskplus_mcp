...
class Config:
    ...
    API_ENDPOINTS = {
        ...
        "user_roles": "/api/v3/user_roles",
        "technician_roles": "/api/v3/technician_roles",
        "admin_user_groups": "/api/v3/admin/users/{user_id}/groups",
        ...
        "role_permissions": "/api/v3/roles/{role_id}/permissions",
